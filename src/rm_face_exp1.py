...
if __name__ == '__main__':
    ...
    data_1 = data.groupby(["spacing_in_deg", "setsize", "stimulus_size", "participant", "stimulus_type"])[
        "deviation_score"] \
        .agg(['mean', 'std']) \
        .reset_index(level = ["spacing_in_deg", "setsize", "stimulus_size", "participant", "stimulus_type"])
    ...
    data_2 = data.groupby(["spacing_in_deg", "setsize", "stimulus_size", "stimulus_type"])[
        "deviation_score"] \
        .agg(['mean', 'std']) \
        .reset_index(level = ["spacing_in_deg", "setsize", "stimulus_size", "stimulus_type"])
